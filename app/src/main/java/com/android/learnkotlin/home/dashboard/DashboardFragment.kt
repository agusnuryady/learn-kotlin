...
import com.android.learnkotlin.DetailActivity
...
class DashboardFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mDatabase = FirebaseDatabase.getInstance("https://learn-kotlin-46088-default-rtdb.asia-southeast1.firebasedatabase.app/")
            .getReference("Film")
